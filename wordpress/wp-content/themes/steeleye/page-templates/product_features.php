<?php
/**
 * Template Name: Product Features
 *
 * @package WordPress
 * @subpackage DRGN
 * @since 
...
<div id="primary" class="content-area">
		<main id="main" class="site-main homepage_main">
			...
			<div class="banner hero_banner" style="background: url('<?php echo $backgroundImg[0]; ?>') no-repeat; background-size: cover;">
				<div class="container">
					<h1><?php the_field('product_features_banner_title'); ?></h1>
			...
			if ( have_posts() ) :
				...
				while ( have_posts() ) :
					 ...
					 */
					get_template_part( 'template-parts/content-product-features', get_post_type() );
